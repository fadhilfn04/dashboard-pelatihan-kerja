  ...
  <div class="h-screen w-screen bg-brand-background">
    <div class="relative h-full w-full overflow-x-hidden">
      ...
      <div
        ...
        :style="{ 'background-image': 'url(' + imageUrl + ')' }"
      ></div>
      <div class="absolute top-40 z-20 h-80 w-full px-16">
        <SumberData />
      </div>
    </div>
...
<script>
import SumberDataNav from "@/components/Navigation/SumberDataNav.vue";
import SumberData from "@/components/DashboardSumberData/SumberData.vue";
