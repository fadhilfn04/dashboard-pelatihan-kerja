...
import UploadManagement from "@/components/UploadManagement/UploadManagement.vue";
import UploadForm from "@/components/UploadManagement/UploadForm.vue";

export default {
  name: "UploadManagementView",
  components: {
    MainNav,
    UploadManagement,
    UploadForm,
