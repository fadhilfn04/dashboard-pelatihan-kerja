...
<script>
import MapProduktifitasNasional from "./MapProduktifitasNasional.vue";
import { ref } from "vue";
import { Modal } from "flowbite-vue";
import axios from "axios";

export default {
  name: "ProduktifitasNasional",
  components: {
    MapProduktifitasNasional,
    Modal,
  },
  data() {
    return {
      ...
      api: "/recap-national-productivity",
  ...
  props: {
    selectedYearTrenProduktifitasTenagaKerja: {
      type: Number,
      default: null,
    },
  },
  watch: {
    selectedYearTrenProduktifitasTenagaKerja(newYear) {
  ...
  methods: {
    updateApi(newYear) {
      ...
      if (newYear) {
        this.api = `/recap-national-productivity-year/${newYear}`;
      } else {
        this.api = `/recap-national-productivity-year/${currentYear}`;
      }
      this.fetchData();
    },
    fetchData() {
