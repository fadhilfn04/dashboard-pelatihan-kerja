    ...
    >
      ...
      >
        <LTooltip>
          ...
          ><br />
          <span class="text-xs font-normal">Jumlah LPK Terakreditasi : {{ marker.value }}</span>
          <br />
          <span class="text-xs font-normal">Jumlah LPK Belum Terakreditasi : {{ marker.value }}</span>
        </LTooltip>
      </LMarker>
    </LMap>
  </div>
